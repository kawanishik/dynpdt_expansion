#ifndef POPLAR_TRIE_PLAIN_BONSAI_NLM_SD_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_NLM_SD_HPP
...
class plain_bonsai_nlm_SD {
  ...
  public:
    plain_bonsai_nlm_SD() = default;

    explicit plain_bonsai_nlm_SD(uint32_t capa_bits) : ptrs_(1ULL << capa_bits) {}
    ...
    void show_stats(std::ostream& os, int n = 0) const {
        ...
        show_stat(os, indent, "name", "plain_bonsai_nlm_SD");
    ...
    plain_bonsai_nlm_SD(const plain_bonsai_nlm_SD&) = delete;
    plain_bonsai_nlm_SD& operator=(const plain_bonsai_nlm_SD&) = delete;

    plain_bonsai_nlm_SD(plain_bonsai_nlm_SD&&) noexcept = default;
    plain_bonsai_nlm_SD& operator=(plain_bonsai_nlm_SD&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_NLM_SD_HPP
