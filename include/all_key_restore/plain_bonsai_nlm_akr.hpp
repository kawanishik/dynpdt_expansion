#ifndef POPLAR_TRIE_PLAIN_BONSAI_NLM_AKR_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_NLM_AKR_HPP
...
class plain_bonsai_nlm_akr {
  ...
  public:
    plain_bonsai_nlm_akr() = default;

    explicit plain_bonsai_nlm_akr(uint32_t capa_bits) : ptrs_(1ULL << capa_bits) {}
    ...
    plain_bonsai_nlm_akr(const plain_bonsai_nlm_akr&) = delete;
    plain_bonsai_nlm_akr& operator=(const plain_bonsai_nlm_akr&) = delete;

    plain_bonsai_nlm_akr(plain_bonsai_nlm_akr&&) noexcept = default;
    plain_bonsai_nlm_akr& operator=(plain_bonsai_nlm_akr&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_NLM_AKR_HPP
