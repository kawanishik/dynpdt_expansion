#ifndef POPLAR_TRIE_PLAIN_BONSAI_TRIE_AKR_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_TRIE_AKR_HPP
...
class plain_bonsai_trie_akr {
  ...
  public:
    plain_bonsai_trie_akr() = default;

    plain_bonsai_trie_akr(uint32_t capa_bits, uint32_t symb_bits) {
    ...
    node_map expand() {
        plain_bonsai_trie_akr new_ht{capa_bits() + 1, symb_size_.bits()};
        new_ht.add_root();
    ...
    void show_stats(std::ostream& os, int n = 0) const {
        ...
        show_stat(os, indent, "name", "plain_bonsai_trie_akr");
    ...
    plain_bonsai_trie_akr(const plain_bonsai_trie_akr&) = delete;
    plain_bonsai_trie_akr& operator=(const plain_bonsai_trie_akr&) = delete;

    plain_bonsai_trie_akr(plain_bonsai_trie_akr&&) noexcept = default;
    plain_bonsai_trie_akr& operator=(plain_bonsai_trie_akr&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_TRIE_AKR_HPP
