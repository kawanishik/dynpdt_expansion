/*
関数 require_centroid_path_order_and_insert_dictionaryのテストファイル
compute_node_and_blanch_num関数を使用して、ノード間の関係性などの取得は問題ないと想定
*/
...
int main() {
    ...
    map.require_centroid_path_order_and_insert_dictionary(new_map, children, node_id, cnt_leaf_per_node, box);
    for(auto b : box) std::cout << b << std::endl;
    
    std::vector<uint64_t> box_exp {
        58985, 38084, 48922, 65267, 54261, 57491, 54031, 1
    };
