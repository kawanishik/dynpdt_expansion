#ifndef POPLAR_TRIE_PLAIN_BONSAI_NLM_DR_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_NLM_DR_HPP
...
class plain_bonsai_nlm_dr {
  ...
  public:
    plain_bonsai_nlm_dr() = default;

    explicit plain_bonsai_nlm_dr(uint32_t capa_bits) : ptrs_(1ULL << capa_bits) {}
    ...
    void show_stats(std::ostream& os, int n = 0) const {
        ...
        show_stat(os, indent, "name", "plain_bonsai_nlm_dr");
    ...
    plain_bonsai_nlm_dr(const plain_bonsai_nlm_dr&) = delete;
    plain_bonsai_nlm_dr& operator=(const plain_bonsai_nlm_dr&) = delete;

    plain_bonsai_nlm_dr(plain_bonsai_nlm_dr&&) noexcept = default;
    plain_bonsai_nlm_dr& operator=(plain_bonsai_nlm_dr&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_NLM_DR_HPP
