#ifndef POPLAR_TRIE_PLAIN_BONSAI_TRIE_DR_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_TRIE_DR_HPP
...
class plain_bonsai_trie_dr {
  ...
  public:
    plain_bonsai_trie_dr() = default;

    plain_bonsai_trie_dr(uint32_t capa_bits, uint32_t symb_bits) {
    ...
    node_map expand() {
        plain_bonsai_trie_dr new_ht{capa_bits() + 1, symb_size_.bits()};
        new_ht.add_root();
    ...
    plain_bonsai_trie_dr(const plain_bonsai_trie_dr&) = delete;
    plain_bonsai_trie_dr& operator=(const plain_bonsai_trie_dr&) = delete;

    plain_bonsai_trie_dr(plain_bonsai_trie_dr&&) noexcept = default;
    plain_bonsai_trie_dr& operator=(plain_bonsai_trie_dr&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_TRIE_DR_HPP
