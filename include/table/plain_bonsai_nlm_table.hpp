#ifndef POPLAR_TRIE_PLAIN_BONSAI_NLM_TABLE_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_NLM_TABLE_HPP
...
class plain_bonsai_nlm_table {
  ...
  public:
    plain_bonsai_nlm_table() = default;

    explicit plain_bonsai_nlm_table(uint32_t capa_bits) : ptrs_(1ULL << capa_bits) {}
    ...
    void show_stats(std::ostream& os, int n = 0) const {
        ...
        show_stat(os, indent, "name", "plain_bonsai_nlm_table");
    ...
    plain_bonsai_nlm_table(const plain_bonsai_nlm_table&) = delete;
    plain_bonsai_nlm_table& operator=(const plain_bonsai_nlm_table&) = delete;

    plain_bonsai_nlm_table(plain_bonsai_nlm_table&&) noexcept = default;
    plain_bonsai_nlm_table& operator=(plain_bonsai_nlm_table&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_NLM_TABLE_HPP
