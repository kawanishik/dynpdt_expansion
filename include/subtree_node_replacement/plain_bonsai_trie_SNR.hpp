#ifndef POPLAR_TRIE_PLAIN_BONSAI_TRIE_SNR_HPP
#define POPLAR_TRIE_PLAIN_BONSAI_TRIE_SNR_HPP
...
class plain_bonsai_trie_SNR {
  ...
  public:
    plain_bonsai_trie_SNR() = default;

    plain_bonsai_trie_SNR(uint32_t capa_bits, uint32_t symb_bits) {
    ...
    node_map expand() {
        plain_bonsai_trie_SNR new_ht{capa_bits() + 1, symb_size_.bits()};
        new_ht.add_root();
    ...
    void show_stats(std::ostream& os, int n = 0) const {
        ...
        show_stat(os, indent, "name", "plain_bonsai_trie_SNR");
    ...
    plain_bonsai_trie_SNR(const plain_bonsai_trie_SNR&) = delete;
    plain_bonsai_trie_SNR& operator=(const plain_bonsai_trie_SNR&) = delete;

    plain_bonsai_trie_SNR(plain_bonsai_trie_SNR&&) noexcept = default;
    plain_bonsai_trie_SNR& operator=(plain_bonsai_trie_SNR&&) noexcept = default;
...
#endif  // POPLAR_TRIE_PLAIN_BONSAI_TRIE_SNR_HPP
